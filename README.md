# CY8CPROTO-040T-AUTO BSP

## Overview

The PSOC™ 4000T AUTO CAPSENSE™ Prototyping Kit enables you to evaluate and develop with Cypress's fifth-generation, low-power CAPSENSE™ solution using the PSOC™ 4000T AUTO device.
...
* CY8CPROTO-040T-AUTO PSOC™ 4000T AUTO CAPSENSE™ Prototyping Kit 
* Quick Start Guide
...
The CY8CPROTO-040T-AUTO Board Support Package provides a set of APIs to configure, initialize and use the board resources.

See the [BSP API Reference Manual][api] for the complete list of the provided interfaces.

## More information
* [CY8CPROTO-040T-AUTO BSP API Reference Manual][api]
* [CY8CPROTO-040T-AUTO Documentation](https://www.infineon.com/evaluation-board/CY8CPROTO-040T-AUTO)
...
[api]: https://infineon.github.io/TARGET_CY8CPROTO-040T-AUTO/html/modules.html
[settings]: https://infineon.github.io/TARGET_CY8CPROTO-040T-AUTO/html/md_bsp_settings.html
